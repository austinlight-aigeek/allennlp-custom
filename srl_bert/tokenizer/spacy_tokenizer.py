...
from srl_bert.util import get_spacy_model
from srl_bert.tokenizer.token_class import Token
from srl_bert.tokenizer.tokenizer import Tokenizer


class SpacyTokenizer(Tokenizer):
    """
    A `Tokenizer` that uses spaCy's tokenizer.  It's fast and reasonable - this is the
    recommended `Tokenizer`. By default it will return srl_bert Tokens,
