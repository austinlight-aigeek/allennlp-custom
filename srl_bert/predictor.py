...
from srl_bert.common import Registrable, plugins
from srl_bert.common.util import JsonDict, sanitize
from srl_bert.data import DatasetReader, Instance
from srl_bert.data.batch import Batch
from srl_bert.models import Model
from srl_bert.models.archival import Archive, load_archive
...
class Predictor(Registrable):
    """
    a `Predictor` is a thin wrapper around an model that handles JSON -> JSON predictions
    ...
    def from_path(
        ...
        **kwargs,
        ...
        import_plugins : `bool`, optional (default=`True`)
            ...
            can be found by `srl_bert.common.plugins.import_plugins()`.
