...
from srl_bert.common.util import JsonDict, sanitize, group_by_count
...
from srl_bert.predictors.predictor import Predictor
...
class SemanticRoleLabelerPredictor(Predictor):
    ...
    def predict_batch_json(self, inputs: List[JsonDict]) -> List[JsonDict]:
        ...
        if not flattened_instances:
            return sanitize([{"verbs": [], "words": self._tokenizer.tokenize(x["sentence"])} for x in inputs])
