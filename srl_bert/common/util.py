...
from srl_bert.common.checks import log_pytorch_version_info
...
def get_frozen_and_tunable_parameter_names(
    ...
    tunable_parameter_names = (name for name, parameter in model.named_parameters() if parameter.requires_grad)
