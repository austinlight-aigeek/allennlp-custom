...
from srl_bert.common.util import push_python_path, import_module_and_submodules
...
def import_plugins() -> None:
    ...
    import_module_and_submodules(
        "srl_bert",
        exclude={
            "srl_bert.sanity_checks",  # deprecated
            "srl_bert.tools",  # things in here are usually run as commands themselves
        },
    )
