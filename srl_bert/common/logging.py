...
def prepare_global_logging(
    ...
    if world_size == 1:
        ...
        formatter = logging.Formatter(f"{rank} | %(asctime)s - %(levelname)s - %(name)s - %(message)s")
    ...
    from srl_bert.common.util import SigTermReceived
    ...
    # also log tqdm
    from srl_bert.common.tqdm import logger as tqdm_logger
