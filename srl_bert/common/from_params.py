...
from srl_bert.common.lazy import Lazy
from srl_bert.common.params import Params
...
def is_base_registrable(cls) -> bool:
    ...
    a class.
    """
    from srl_bert.common.registrable import Registrable  # import here to avoid circular imports
...
def pop_and_construct_arg(
    ...
    """
    from srl_bert.models.archival import load_archive  # import here to avoid circular imports
