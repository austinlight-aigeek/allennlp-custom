...
from srl_bert.common.util import is_distributed
from srl_bert.common.checks import ConfigurationError
from srl_bert.training.metrics.metric import Metric
...
class SrlEvalScorer(Metric):
    ...
    def __call__(
        ...
        with open(predicted_path, "w", encoding="utf-8") as predicted_file, open(
            ...
            for verb_index, sentence, predicted_tag_sequence, gold_tag_sequence in zip(
                ...
                from srl_bert.structured_prediction.models.srl import (
        ...
        try:
            ...
            raise FileNotFoundError("'File not found' while running the evaluation. Do you have perl installed?")
    ...
    def get_metric(self, reset: bool = False):
        ...
        """
        if is_distributed():
            raise RuntimeError("Distributed aggregation for `SrlEvalScorer` is currently not supported.")
