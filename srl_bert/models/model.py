...
from srl_bert.common.checks import ConfigurationError
from srl_bert.common.params import Params, remove_keys_from_params
from srl_bert.common.registrable import Registrable
from srl_bert.data import Instance, Vocabulary
from srl_bert.data.batch import Batch
from srl_bert.nn import util
from srl_bert.nn.module import Module
from srl_bert.nn.parallel import DdpAccelerator
from srl_bert.nn.regularizers import RegularizerApplicator
...
class Model(Module, Registrable):
    ...
    def _load(
        ...
        def filter_out_authorized_missing_keys(module, prefix=""):
            ...
            for pat in getattr(module.__class__, "authorized_missing_keys", None) or []:
                missing_keys = [
                    k for k in missing_keys if k.startswith(prefix) and re.search(pat[len(prefix) :], k) is None
                ]
    ...
    def from_archive(cls, archive_file: str, vocab: Vocabulary = None) -> "Model":
        ...
        """
        from srl_bert.models.archival import load_archive  # here to avoid circular imports
